...
export default function Todos() {
  ...
  return (
    <div className="bg-white/90 backdrop-blur-sm p-4 md:p-6 lg:p-8 rounded-3xl shadow-2xl mb-6 md:mb-8 border border-gray-100 max-w-4xl mx-auto mt-10">
      ...
      {/* Tiến độ hoàn thành */}
      <div className="mb-6 bg-gradient-to-r from-blue-500 via-indigo-500 to-purple-500 text-white p-6 rounded-2xl shadow-xl">
        <div className="flex items-center justify-between mb-4">
          <div>
            <p className="text-sm font-medium opacity-90 mb-1">Tiến độ hoàn thành</p>
        ...
        <div className="relative">
          ...
          <p className="text-right text-xs font-semibold mt-2 opacity-90">{progress}% hoàn thành</p>
        </div>
      </div>
          ...
          <ul className="space-y-2 text-left">
            {todos.length === 0 ? (
              <li className="text-center py-16 bg-white/80 backdrop-blur-sm rounded-3xl shadow-lg border-2 border-dashed border-blue-300">
                ...
                <p className="text-gray-600 text-xl font-medium mb-2">Chưa có việc nào</p>
              ...
              todos.map((item) => (
                ...
                >
                  ...
                  <div className="flex gap-2 opacity-100 md:opacity-0 group-hover:opacity-100 transition-opacity duration-200">
                    ...
                    <button
                      type="button"
                      className="px-5 py-2.5 bg-gradient-to-r from-red-500 to-pink-600 hover:from-red-600 hover:to-pink-700 text-white text-sm font-semibold rounded-xl transition-all duration-200 transform hover:scale-105 shadow-lg hover:shadow-xl"
